...
AppFailure<T> appExceptionToFailure<T>(AppException exception, StackTrace stack) {
...
AppFailure<T> dynamicErrorToFailure<T>(dynamic e, StackTrace stack) {
  ...
  return appExceptionToFailure(AppException(e.message ?? e.toString(), stack), stack);
}
...
$responseLog''';
  ...
  String get _api => response.requestOptions.baseUrl + response.requestOptions.path;
}

class UnauthorizedException extends AppException {
  UnauthorizedException(StackTrace stackTrace) : super("Unautorized", stackTrace);
}

class CancelledException extends AppException {
  CancelledException(StackTrace stackTrace) : super("CancelledException", stackTrace);
}
...
class InvalidPasswordException extends AppException {
  InvalidPasswordException(StackTrace stackTrace) : super("Password is invalid", stackTrace);
}

class InvalidEmailOrPasswordException extends AppException {
  InvalidEmailOrPasswordException(StackTrace stackTrace, String message) : super("Email or Password Wrong", stackTrace);
}
