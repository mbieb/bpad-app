...
import 'package:bpad_app/app/infrastructure/storage/secure_storage.dart';
import 'package:bpad_app/app/infrastructure/storage/storage_key.dart';
...
class AuthLocalDataSource {
  ...
  Future<bool> checkIfAppIsInitial() async {
    var isNotInitial = await _storage.get<bool?>(StorageKeyConstant.appNotInitial);
