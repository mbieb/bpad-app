...
import 'package:bpad_app/app/domain/auth/auth_failure/auth_failure.dart';
import 'package:bpad_app/app/domain/auth/auth_form.dart/auth_form.dart';
import 'package:bpad_app/app/domain/auth/auth_success/auth_success.dart';
import 'package:bpad_app/app/domain/auth/i_auth_repository.dart';
...
import 'package:bpad_app/app/domain/user/user.dart';
import 'package:bpad_app/app/domain/utils/common_util.dart';
import 'package:bpad_app/app/infrastructure/auth/auth_local_data_source.dart';
import 'package:bpad_app/app/infrastructure/auth/auth_remote_data_source.dart';
import 'package:bpad_app/app/infrastructure/auth/dto/user_dto.dart';
...
class AuthRepository implements IAuthRepository {
  ...
  @override
  Future<Either<AppFailure<AuthFailure>, User>> checkIntialStatusAndGetUser() async {
    try {
  ...
  @override
  Future<Either<AppFailure<AuthFailure>, User>> getUserFromLocalStorage() async {
  ...
  @override
  Future<Either<AppFailure<AuthFailure>, AuthSuccess>> register(RegisterForm form) async {
    try {
  ...
  @override
  Future<Either<AppFailure<AuthFailure>, AuthSuccess>> signIn(SignInForm form) async {
    try {
  ...
  @override
  Future<Either<AppFailure<AuthFailure>, List<DropdownText>>> getProvinceList() async {
    try {
  ...
  @override
  Future<Either<AppFailure<AuthFailure>, String?>> takePicture(ImageSource imageSource) async {
    try {
      final imagePath = await _authRemoteDataSource.takePicture(imageSource: imageSource);
  ...
  @override
  Future<Either<AppFailure<AuthFailure>, AuthSuccess>> updateProfile(ProfileForm form) async {
    try {
      UserDto user = await _authLocalDataSource.getUser();
