...
import 'package:bpad_app/app/infrastructure/api_helper/api_helper.dart';
import 'package:bpad_app/app/infrastructure/api_helper/api_path.dart';
import 'package:bpad_app/app/infrastructure/auth/dto/province_dto.dart';
...
class AuthRemoteDataSource {
  ...
  Future<UserDto> signIn({
    ...
    final user = await FirebaseFirestore.instance.collection('users').doc(result.user!.uid).get();
  ...
  Future<UserDto> register({
    ...
    final birthDate = DateFormat('dd-MM-yyyy').format(form.birthDate.toNullable()!);
  ...
  Future<String?> takePicture({
    ...
    XFile? image = await _imagePicker.pickImage(source: imageSource, imageQuality: 50);
