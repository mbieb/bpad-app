...
import 'package:bpad_app/app/application/initial/initial_bloc.dart';
import 'package:bpad_app/app/presentation/constants/images.dart';
...
class SplashScreenPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<InitialBloc>()..add(const InitialEvent.started()),
      ...
      listener: (context, state) {
        state.map(
            ...
            authenticated: (authenticated) {
              context.read<AuthBloc>().add(AuthEvent.patch(user: authenticated.user));
