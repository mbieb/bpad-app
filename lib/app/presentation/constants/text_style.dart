...
//REGULAR
final TextStyle _regularTextStyle = _textStyle.copyWith(fontWeight: FontWeight.w400);
...
//MEDIUM
final TextStyle _mediumTextStyle = _textStyle.copyWith(fontWeight: FontWeight.w500);
...
//BOLD
final TextStyle _boldTextStyle = _textStyle.copyWith(fontWeight: FontWeight.w700);

final TextStyle cTextBold2XS = _baseTextStyle2XS.merge(_boldTextStyle);
final TextStyle cTextPrimaryBold2XS = cTextBold2XS.copyWith(color: cColorPrimary);
...
final TextStyle cTextPrimaryBold2XL = cTextBold2XL.copyWith(color: cColorPrimary);
...
final TextStyle cTextPrimaryBold3XL = cTextBold3XL.copyWith(color: cColorPrimary);
