import 'package:bpad_app/app/application/main_tab/main_tab_cubit.dart';
import 'package:bpad_app/app/domain/main_tab/main_tab_view.dart';
...
import 'package:bpad_app/app/presentation/pages/employee/employee_page.dart';
import 'package:bpad_app/app/presentation/pages/home/home_page.dart';
import 'package:bpad_app/app/presentation/pages/instansi/instansi_page.dart';
import 'package:bpad_app/app/presentation/pages/profile/profile_page.dart';
import 'package:bpad_app/app/presentation/pages/vehicle/vehicle_page.dart';
        ...
        return PopScope(
          ...
          child: AppScaffold(
            ...
            body: view.map(
              ...
              employee: (_) => const EmployeePage(),
              instansi: (_) => const InstansiPage(),
              vehicle: (_) => const VehiclePage(),
