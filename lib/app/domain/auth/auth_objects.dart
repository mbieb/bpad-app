...
import 'package:bpad_app/app/domain/value_objects.dart';
import 'package:bpad_app/app/domain/value_validators.dart';
...
class FullName extends ValueObject<ValueFailure<String>, String> {
  ...
  Either<ValueFailure<String>, String> get failureOrValue =>
      ValueValidators.validateStringNotEmpty(value).flatMap((a) => ValueValidators.validateMaxStringLength(a, 30));
}
...
class ConfirmPassword extends ValueObject<ValueFailure<String>, String> {
  ...
  @override
  Either<ValueFailure<String>, String> get failureOrValue => ValueValidators.validateStringNotEmpty(value)
...
class SignInPassword extends ValueObject<ValueFailure<String>, String> {
  ...
  @override
  Either<ValueFailure<String>, String> get failureOrValue =>
      ValueValidators.validateStringNotEmpty(value).flatMap((a) => ValueValidators.validateMinStringLength(a, 8));
}
...
class EmailAddress extends ValueObject<ValueFailure<String>, String> {
  ...
  @override
  Either<ValueFailure<String>, String> get failureOrValue =>
      ValueValidators.validateStringNotEmpty(value).flatMap((value) => ValueValidators.validateEmail(value));
}
...
class MobilePhoneNumber extends ValueObject<ValueFailure<String>, String> {
  ...
  @override
  Either<ValueFailure<String>, String> get failureOrValue =>
      ValueValidators.validateStringNotEmpty(value).flatMap((value) => ValueValidators.validateStringNotEmpty(value));
}
