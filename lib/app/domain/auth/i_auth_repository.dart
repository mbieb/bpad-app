...
abstract class IAuthRepository {
  ...
  Future<Either<AppFailure<AuthFailure>, AuthSuccess>> register(RegisterForm form);
  Future<Either<AppFailure<AuthFailure>, AuthSuccess>> updateProfile(ProfileForm form);
  Future<Either<AppFailure<AuthFailure>, List<DropdownText>>> getProvinceList();
  Future<Either<AppFailure<AuthFailure>, String?>> takePicture(ImageSource imageSource);
  Future<void> signOut();
}
